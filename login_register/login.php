    ...
    <section class="container-fluid mt-5 pt-3 mb-4 text-white">
        ...
        <section class="col-12 col-sm-6 col-md-4">
            <form class="form-container" action="login.php" method="POST">
                ...
                <h2 class="text-center font-weight-bold pb-2 "> Sign-In </h2>
                <?php if($error != ''){ ?>
                ...
                <button class="btn btn-danger mt-3 mx-auto d-block col-12" type="submit" name="submit">Sign In</button>
                <div class="form-footer text-center mt-2">
                    <p> Belum punya account? <br><a href="register.php" class="text-danger" style="text-decoration:none;">Register</a></p>
                </div>
            </form>
        </section>
        </section>
